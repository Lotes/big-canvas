...
TINY.editor = function() {
	...
	function edit(n, obj) {
		this.n = n; window[n] = this; this.t = obj.element; this.obj = obj; this.xhtml = obj.xhtml;
	...
	edit.prototype.getContents = function() {
		return this.i.contentWindow.document.body.innerHTML;
	};
	edit.prototype.setContents = function(text) {
		this.i.contentWindow.document.body.innerHTML = text;
	};
	return { edit : edit }
}();
